...
def replication_logistic_regression(n_procs, n_samples, n_features, input_dir, n_stragglers, is_real_data, params, add_delay, update_rule):
    ...
    comm.Barrier()
    if rank == 0:
        print("---- Starting Replication Iterations for " +str(n_stragglers) + " stragglers" + "simulated delay " + str(add_delay) + "-------")
...
def replication_linear_regression(n_procs, n_samples, n_features, input_dir, n_stragglers, is_real_data, params, add_delay, update_rule):
